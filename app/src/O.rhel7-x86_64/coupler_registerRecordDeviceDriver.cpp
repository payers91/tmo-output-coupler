...
/* Generated from ../O.Common/coupler.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devWaveformStats, *pvar_dset_asynWfOctetCmdResponse,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAoSoftCallback", "devAoStats", "asynAoInt32", "asynAoFloat64",
    "asynAoInt64", "devaoStream", "asynRecordDevice", "devBiSoft",
    ...
    "devSiEnviron", "devStringinStats", "devStringinEnvVar",
    "devStringinEpics", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
...
int coupler_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/reg/g/pcds/epics-dev/payers/coupler/coupler/current";
...
/* coupler_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"coupler_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(coupler_registerRecordDeviceDriver(*iocshPpdbbase));
}
